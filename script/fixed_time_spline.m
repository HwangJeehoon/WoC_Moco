...
% jobs{1} = struct('result_name', 'fixedTimeSpline2_0.4', ...
%                      'fixedInterval', [0.2, 0.4]);
% 
% jobs{2} = struct('result_name', 'fixedTimeSpline2_0.45', ...
%                      'fixedInterval', [0.25, 0.45]);
% 
% jobs{3} = struct('result_name', 'fixedTimeSpline2_0.5', ...
%                      'fixedInterval', [0.3, 0.5]);

jobs{1} = struct('result_name', 'fixedTimeSpline2_0.55', ...
                     'fixedInterval', [0.35, 0.55]);

jobs{2} = struct('result_name', 'fixedTimeSpline2_0.6', ...
